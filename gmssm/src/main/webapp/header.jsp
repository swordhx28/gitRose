		...
		<div id="header">
			...
			<div class="menu">
				<ul>
					...
					<li class="txt"><a href="#" target="_parent">购物车</a></li>
			...
			<div class="f_r w62p">
				<ul>
					<li class="txt hello">你好，欢迎&nbsp;${resultUser.loginName}&nbsp;访问贵美商城！<script type="text/JavaScript">showTime();</script></li>
				</ul>
			</div> 
  		<div class="nav f_l w100p">
  			<ul>
  				...
  				<%
  				List<Category> cateList = (List<Category>)request.getAttribute("categoryName");
				for(Category category : cateList){
					%><li><a href="catlist.jsp" target="_parent"><%=category.getName() %></a></li><%
				}
				%>
